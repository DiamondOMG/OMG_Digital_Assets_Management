    ...
    <div className="d-flex align-items-center justify-content-center min-vh-100 bg-light">
      <div className="card p-4" style={{ width: "400px" }}>
        <div className="text-center mb-4">
          <div
            className={`rounded-circle mx-auto d-flex align-items-center ${styles.boxLogoRegister}`}
        ...
        <form onSubmit={handleRegister}>
          ...
          <button type="submit" className={`w-100 mb-2 ${styles.registerBtn}`}>
            Register now
          </button>
          <Link href="/" className={`btn btn-light w-100  ${styles.backBtn}`}>
            Back
          </Link>
        </form>
      </div>
