...
const Login = () => {
	...
	const searchParams = useSearchParams(); // ใช้สำหรับอ่าน query string
		...
		const handleGoogleLogin = () => {
			...
			window.location.href = 'https://accounts.google.com/o/oauth2/v2/auth?client_id=58925176098-4s7j4uqgh9h77e1n74af32kt1spfml89.apps.googleusercontent.com&redirect_uri=http://localhost:8000/users/google_signup&response_type=code&scope=email%20profile%20openid&state=12345&prompt=consent';
		};
