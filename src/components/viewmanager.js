...
const ViewManager = ({
	...
	const filteredViews = views.filter((view) =>
		view.name.toLowerCase().includes(searchTerm.toLowerCase()) // ++++++++++++++++ กรอง Views ตาม searchTerm
	);
				...
				<div className="card mb-3">
					<div className="card-body">
						...
						<div className="d-flex justify-content-between">
							...
							{/* +++++++++ ปุ่ม Add views ++++++++++ */}
							<i className="bi bi-plus-square me-2 icon-hover"
						...
						{filteredViews.map((view, index) => ( // ใช้ filteredViews ที่กรองแล้วแทน views
							<div
								key={index}
